...
ondeSalvar = r'C:\Users\User\Documents\GitHub\data-analytics-back-end\src\ArquivosDRE\\'

print('Iniciando as analises...')
tempoLimp = limp_plan(caminhoPastaLimp, ondeSalvar)
tempoForge = forgePlan(caminhoForge, ondeSalvar, 2024, 1)
